...
namespace SoundSleuth
{
	...
	public partial class App
	{
		...
		public const string CONFIG_PATH = "SoundSleuth.json";
		...
		private App()
		{
			new Mutex(true, "SoundSleuth", out var isNew);
			...
			_notifyIcon = new NotifyIcon
			{
				...
				Icon = SoundSleuth.Properties.Resources.Logo,
				Visible = true
			};
		...
		private async void StartListening()
		{
			...
			_isListening = true;
			_notifyIcon.Icon = SoundSleuth.Properties.Resources.LogoActiveAlt;
			...
			timer.Elapsed += (_, _) =>
			{
				_notifyIcon.Icon = frame++ % 2 == 0 ? SoundSleuth.Properties.Resources.LogoActive : SoundSleuth.Properties.Resources.LogoActiveAlt;
			};
			...
			_notifyIcon.Icon = SoundSleuth.Properties.Resources.Logo;
			_isListening = false;
			timer.Stop();
		}
	}
