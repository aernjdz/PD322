...
namespace SoundSleuth
{
    internal static class Toaster
    {
		...
		private static readonly string ThumbImagePath = Path.Join(TempPath, "SoundSleuth_dynamic_thumb.tmp");
		private static readonly string BannerImagePath = Path.Join(TempPath, "SoundSleuth_dynamic_banner.tmp");

		private static readonly string ShazamIconPath = Path.Combine(TempPath, "SoundSleuth_static_shazam.tmp");
		private static readonly string YouTubeIconPath = Path.Combine(TempPath, "SoundSleuth_static_youtube.tmp");
		private static readonly string CopyIconPath = Path.Combine(TempPath, "SoundSleuth_static_copy.tmp");
		...
		public static async Task ShowSuccess(SoundSleuthMatch match)
		{
